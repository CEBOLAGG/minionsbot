...
class DiscordMusicBot extends Client {
      ...
      const filtersMenu = new ActionRowBuilder().addComponents(
        new StringSelectMenuBuilder()
          ...
          .addOptions([
            ...
            { label: 'Equalizador', value: 'eq', description: 'Liga/desliga o equalizador de 5 bandas', emoji: emojiFor("stats") },
  ...
  createPlayerV2(guild, player, track, options = {}) {
    ...
    // O EQ agora é uma OPÇÃO dentro do dropdown de filtros (toggle).
