...
const { EmbedBuilder, ActionRowBuilder, ButtonBuilder, StringSelectMenuBuilder, ButtonStyle, Colors, MessageFlags } = require("discord.js");
    ...
    .setRun(async (client, interaction) => {
        ...
        function createRouletteEmbed() {
            ...
            if (rouletteState.spinning) {
                ...
                embed.addFields({ name: "Participants", value: names.join("\n") || "No participants", inline: true });
            } else {
            ...
            const spinInterval = setInterval(async () => {
                ...
                if (currentUpdate >= totalUpdates) {
                    ...
                    const winnerEmbed = new EmbedBuilder()
                        ...
                        .addFields({ name: "Participants", value: names.join("\n"), inline: true })
                        .setFooter({ 
