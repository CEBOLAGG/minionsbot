	...
	.setRun(async (client, interaction) => {
		...
		try {
			...
			const clearEmbed = new EmbedBuilder()
				...
				.addFields({ name: "User", value: `${target.tag} (${target.id})`, inline: false })
				.addFields({ name: "Moderator", value: `${interaction.user.tag}`, inline: false })
				.addFields({ name: "Warnings Cleared", value: `${clearedCount}`, inline: false })
				.addFields({ name: "Remaining Warnings", value: `${remainingCount}`, inline: false })
				.setTimestamp();
